...
class PageScreenEvent extends StatefulWidget {
  PageScreenEvent({Key key}) : super(key: key);

  @override
  _PageScreenEventState createState() => _PageScreenEventState();
}

class _PageScreenEventState extends State<PageScreenEvent> {
  String _message = '';
